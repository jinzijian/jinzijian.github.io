        ...
        <main id="main">
          <section className="intro" aria-labelledby="intro-title">
            <div className="intro-copy">
              <p className="eyebrow"><span className="small-square" /> Senior Research Engineer · Meta MRS</p>
              ...
              <p className="bio">I work on coding agents and reinforcement learning for long-horizon ML workflows. At Meta MRS, I build agents that learn from execution feedback and turn research ideas into runnable experiments.</p>
            ...
            <figure className="portrait-block">
              <div className="portrait-frame"><img src="/portrait.png" alt="Zijian Jin" width={480} height={560} fetchPriority="high" /></div>
          ...
          <section className="experience-section" id="experience" aria-labelledby="experience-title">
            ...
            {[
              { company: 'Meta', role: 'Senior Research Engineer · MRS', dates: 'Jan 2026 — Present', detail: 'Coding agents and reinforcement learning for long-horizon machine learning research workflows.' },
